...
holder.itemView.setOnClickListener(new View.OnClickListener() {
    ...
    private void delete(final int position, View v) {
        ...
        File file=new File(String.valueOf((mFiles.get(position).getPath())));
...
if(deleted){
    ...
    mFiles.remove(position);
        ...
        Snackbar.make(v,"Yes,File Deleted",Snackbar.LENGTH_LONG).show();
    }
else
{
